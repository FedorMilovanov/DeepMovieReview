      ...
      <section className="sectionShell sectionRule discoverySection" aria-labelledby="discovery-title">
        ...
        <div className="discoveryPanel">
          <article className="discoveryCard">
            ...
            <strong>«Шоу Трумана» · 1998</strong>
            <p>
              Издание зафиксировано. Разбор собран по вторичным источникам: пятнадцать сцен, тридцать пять доказательств,
          ...
          <article className="discoveryCard">
            ...
            <p>
              ...
              труда. Разбор собран по вторичным источникам: четырнадцать сцен, двадцать семь доказательств,
