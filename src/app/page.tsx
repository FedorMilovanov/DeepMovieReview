      ...
      <section className="sectionShell sectionRule discoverySection" aria-labelledby="discovery-title">
        ...
        <div className="discoveryPanel">
          <article className="discoveryCard">
            ...
            <strong>«Шоу Трумана» · 1998</strong>
            <p>
              Издание зафиксировано. Разбор собран по вторичным источникам: двенадцать сцен, тридцать доказательств,
          ...
          <article className="discoveryCard">
            ...
            <p>
              ...
              труда. Разбор собран по вторичным источникам: двенадцать сцен, двадцать четыре доказательства,
