  ...
  return (
    <html lang="ru">
      <body style={{ margin: 0, background: "#050505", color: "#f2eee8", fontFamily: "Arial, Helvetica, sans-serif" }}>
        ...
        >
          {/* role=alert stays on the text block only: it would override the
              main landmark on <main>, and actions do not belong inside an
              assertive live region. */}
          <div role="alert" style={{ display: "grid", gap: "1.25rem", alignContent: "center" }}>
